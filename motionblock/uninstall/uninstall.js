import { BASE_COPY, LOCALE_COPY } from './copy/index.js?v=20260704-1';
import { getFeedbackMetadata, populateFeedbackFields } from './form.js?v=20260704-1';
import { getCanonicalLocale, RTL_LOCALES } from './params.js?v=20260704-1';
